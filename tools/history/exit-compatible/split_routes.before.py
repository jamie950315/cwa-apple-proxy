"""Manage narrowly scoped Apple relay subnet advertisements. Client Exit Node stays None.
...
def status():
    ...
    result={'transportVersion':'1.0.1','mode':'split-dns-relay-routes','time':int(time.time()),
            'requiredClientExitNode':'None','requestedRoutes':desired,'advertisedRoutes':advertised,
            ...
            'scope':'Weather DNS maps directly to Pi5; additional relay destination subnets use Pi5. General default route stays unchanged.',
